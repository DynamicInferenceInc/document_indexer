...
from document_indexer.ports import DocumentReader
...
class DoclingDocumentReader:
    ...
    def _get_converter(self) -> Any:
        ...
        try:
            ...
            raise RuntimeError(
                "Reading documents requires docling; install with: pip install 'document-indexer[docling]'"
            ) from exc
        return self._converter
    ...
    def _get_chunker(self) -> Any:
        ...
        try:
            ...
            raise RuntimeError(
                "Chunking documents requires docling; install with: pip install 'document-indexer[docling]'"
            ) from exc
        return self._chunker
